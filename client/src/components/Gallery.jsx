...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="py-16 px-4 bg-gray-50 overflow-hidden">
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.className =
                    'aspect-video flex items-center justify-center bg-gray-800';
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.parentElement.className =
                        'w-20 h-20 rounded-lg flex items-center justify-center bg-gray-200';
                ...
                <div className="aspect-video">
                  <img
                    ...
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.parentElement.className =
                        'aspect-video flex items-center justify-center bg-gray-900';
                      e.target.parentElement.innerHTML = `
                        <div class="text-center text-white p-8">
